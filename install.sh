...
set -e
VERSION="0.10.0"
LINUX_DIST="https://github.com/okta/okta-cli/releases/download/okta-cli-tools-0.10.0/okta-cli-linux-0.10.0-x86_64.zip"
DARWIN_DIST="https://github.com/okta/okta-cli/releases/download/okta-cli-tools-0.10.0/okta-cli-macos-0.10.0-x86_64.zip"
